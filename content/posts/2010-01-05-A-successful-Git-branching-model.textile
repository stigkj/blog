...
modified_at: 2010-01-05
title: A successful Git branching model
alt_url: /archives/343
---
...
It focuses around "Git":http://git-scm.com as the tool for the versioning of
all of our source code.

h2. Why git?

For a thorough discussion on the pros and cons of Git compared to centralized
source code control systems, "see":http://whygitisbetterthanx.com/
"the":http://www.looble.com/git-vs-svn-which-is-better/
"web":http://git.or.cz/gitwiki/GitSvnComparsion. There are plenty of flame wars
...
considered one of the core parts of your _daily_ workflow, really. For example,
in CVS/Subversion "books":http://svnbook.red-bean.com, branching and merging is
first discussed in the later chapters (for advanced users), while in
"every":http://book.git-scm.com
"Git":http://pragprog.com/titles/tsgit/pragmatic-version-control-using-git
"book":http://github.com/progit/progit, it's already covered in chapter 3
(basics).
...
h2. Decentralized but centralized

The repository setup that we use and that works well with this branching model,
is that with a central "truth" repo. Note that this repo is only [_considered_]
...
!(right bordered)/img/2009/12/bm002.png!
...
@HEAD@ always reflects a _production-ready_ state.
...
production release _by definition_. We tend to be very strict at this, so that
...
branch types are categorized by how we _use_ them. They are of course plain old
Git branches.

h3. Feature branches

!(right bordered)/img/2009/12/fb.png!
...
h4. Incorporating a finished feature on develop
...
!/img/2010/01/merge-without-ff.png!
...
change—the point being that _some_ files change.) Then, the bumped version
number is committed.
...
@master@ (since every commit on @master@ is a new release _by definition_,
...
The release is now done, and tagged for future reference.<br />
...
!(right bordered)/img/2010/01/hotfix-branches1.png!
...
bc. $ git checkout -b hotfix-1.2.1 master
...
bc. $ git commit -m "Fixed severe production problem"
...
"gitflow-model.src.key":/img/2010/01/gitflow-model.src.key_.zip of the main
diagram image (Apple Keynote).+

<table border="0">
<tbody>
<tr>
<td align="center"><a onclick="javascript:pageTracker._trackPageview('/wp-content/uploads/wp-content/uploads/2010/01/Git-branching-model.pdf');" href="http://nvie.com/wp-content/uploads/2010/01/Git-branching-model.pdf"><img class="alignnone size-full wp-image-383" title="Download PDF" src="http://nvie.com/wp-content/uploads/2010/01/pdf_icon.png" alt="" width="128" height="128" /></a></td>
</tr>
<tr>
<td align="center"><strong><a onclick="javascript:pageTracker._trackPageview('/wp-content/uploads/wp-content/uploads/2010/01/Git-branching-model.pdf');" href="http://nvie.com/wp-content/uploads/2010/01/Git-branching-model.pdf">Git-branching-model.pdf</a></strong></td>
</tr>
</tbody>
</table>
