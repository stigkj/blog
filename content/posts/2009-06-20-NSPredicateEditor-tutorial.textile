...
!(veryleft)/img/2009/07/hookup-appdelegate.png!
!(right)/img/2009/07/choose-delegate.png!

p(clear). Drag a new NSWindow to the XIB-file and call it Sheet. Make sure the checkbox "Visible At Launch" is deselected or the sheet will not display properly at runtime. Open the main window and add a NSButton and a NSTextView to it. To the sheet window, drag a NSPredicateEditor and a NSButton. They should look somewhat like this now:
...
!/img/2009/07/hookup-windows.png!
...
!(veryleft)/img/2009/07/Picture-10.png!
!(right)/img/2009/07/Picture-13.png!
...
p=. !http://nvie.com/wp-content/uploads/2009/07/zipfile.png!:/files/2009/07/PredicateEditorTest.zip<br />
"PredicateEditorTest.zip":/files/2009/07/PredicateEditorTest.zip
