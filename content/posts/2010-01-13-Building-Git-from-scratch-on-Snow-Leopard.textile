...
---
When you try to build Git "from scratch":http://github.com/git/git on a Snow Leopard machine, you may have ran into the following problem:
...
Then, you have a pretty big change you are having an old Darwin ports ("macports":http://www.macports.org) collection in use which has not yet been upgraded to Snow Leopard's new x64 architecture.
...
<pre><code>$ make NO_DARWIN_PORTS=1 prefix=/usr/local/bin/git</code></pre>